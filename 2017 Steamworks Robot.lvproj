...
<Project Type="Project" LVVersion="16008000">
	...
	<Property Name="varPersistentID:{0424BDDF-C4CB-41D8-9408-AF753F345A28}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/elapsed time (ms)</Property>
	<Property Name="varPersistentID:{053AB6CB-FF25-4921-ABB7-79BAF69C926A}" Type="Ref">/Target/Team Code/JPL Array.vi/One Shot Rising with Input/input</Property>
	<Property Name="varPersistentID:{0766733E-5C37-40AA-A15D-0AFA94F35098}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/input</Property>
	<Property Name="varPersistentID:{0A443451-D0B3-45A5-A6AE-593D34077C6E}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/error out</Property>
	<Property Name="varPersistentID:{13267702-73BA-461F-BC15-41FE2CC21428}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/preset time (ms)</Property>
	<Property Name="varPersistentID:{243FEF2B-44EB-411F-9EBB-D924F2C3CC95}" Type="Ref">/Target/Team Code/JPL Array.vi/One Shot Rising with Input/error in</Property>
	<Property Name="varPersistentID:{3D6B49A9-0CC3-4E8D-AAF0-4C7D15188A74}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/error in</Property>
	<Property Name="varPersistentID:{4DE34E1A-0E34-4CB0-8E8D-CA323B793212}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/output</Property>
	<Property Name="varPersistentID:{5B531ED7-E8AA-4ADF-92C4-5B2D62C04FE2}" Type="Ref">/Target/Team Code/JPL Array.vi/One Shot Rising with Input/output</Property>
	<Property Name="varPersistentID:{83C8486C-5D2D-4A6A-A4DB-0D87A3FE7426}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/input</Property>
	<Property Name="varPersistentID:{8AD80DDA-3B2E-44A4-AA01-476BAA6EF801}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/error out</Property>
	<Property Name="varPersistentID:{8F80CB06-AE64-44D0-812F-2821342CC404}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/preset time (ms)</Property>
	<Property Name="varPersistentID:{A58B391A-D9EF-4A3A-9599-E0689BEADC61}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/output</Property>
	<Property Name="varPersistentID:{C21FF497-7F8D-44DF-BB49-1EA286619748}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/input</Property>
	<Property Name="varPersistentID:{D821089A-FEA4-4B5C-A8EB-E15AF56B1DC9}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/error in</Property>
	<Property Name="varPersistentID:{D829E540-8DCC-4AB8-A933-35E9B3F0B4CB}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/preset time (ms)</Property>
	<Property Name="varPersistentID:{DC4DCD62-20AC-43C1-8921-CD7B5C9993D4}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/error out</Property>
	<Property Name="varPersistentID:{E93F85BA-F07E-4C3D-909E-7C97E6EB18B5}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/elapsed time (ms)</Property>
	<Property Name="varPersistentID:{EAB57A6B-1EF7-42E3-A009-279C855095E5}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer/elapsed time (ms)</Property>
	<Property Name="varPersistentID:{EB0B9ECA-2CB5-48A1-AF88-875854409DA5}" Type="Ref">/Target/Team Code/Teleop.vi/Timer Off Delay/error in</Property>
	<Property Name="varPersistentID:{EE033EBE-F740-46B4-85A8-F9D705B1EA76}" Type="Ref">/Target/Team Code/JPL Array.vi/One Shot Rising with Input/error out</Property>
	<Property Name="varPersistentID:{FFDEF335-4196-4DCD-BD65-4D39DE487E50}" Type="Ref">/Target/Team Code/Teleop.vi/Pulse Timer 1/output</Property>
	...
	<Item Name="Target" Type="RT myRIO">
		...
		<Property Name="alias.value" Type="Str">roboRIO-3596-FRC.local</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="JPL Array.vi" Type="VI" URL="../JPL Array.vi">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Vision 2017.vi" Type="VI" URL="../Vision 2017.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/FIRSTMentor/Documents/LabVIEW Data/2017 Steamworks Robot/Builds</Property>
